    ...
    >
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <button-counter/>
          <p>Below is a list of common names!</p>
          <ul id="getNames">
...
import GameOfThrones from '~/pages/gameofthrones.js'
import Vue from 'vue';
...
var getNames = new Vue({
  el: '#getNames',
  data: {
    items: [ { message: 'GameOfThrones.asyncData()' }, { message: 'hello world' }]
  },
})
